...
if($jwt){
    ...
    try {
        ...
        if (!empty($admin->ann_name) && !empty($admin->ann_id) && !empty($admin->ann_date) && !empty($admin->ann_time) && !empty($admin->ann_description) && !empty($admin->ann_address) && $admin->updateAnnouncement()) 
        {
            // set response code
            ...
            echo json_encode(array("message" => "Event/Announcement Updated!"));
            ...
            echo json_encode(array("message" => "Unable to update announcement. Please try again later."));
        }
