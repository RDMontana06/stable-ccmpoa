...
(function (global, factory) {
    ...
    const getContainer = () =>
        document.body.querySelector(".".concat(swalClasses.container));
    ...
    const handleInputOptions = (instance, params) => {
        ...
        const processInputOptions = (inputOptions) =>
            populateInputOptions[params.input](
                popup,
        ...
        select: (popup, inputOptions, params) => {
            ...
            inputOptions.forEach((inputOption) => {
                ...
                if (Array.isArray(optionLabel)) {
                    ...
                    optionLabel.forEach((o) =>
                        renderOption(optgroup, o[1], o[0])
                    );
                } else {
                    // case of <option>
    ...
    const deny = (instance, value) => {
        ...
        if (innerParams.preDeny) {
            ...
            preDenyPromise
                ...
                .catch((error$$1) =>
                    rejectWith(instance || undefined, error$$1)
                );
        } else {
            instance.closePopup({
                isDenied: true,
    ...
    const addKeydownHandler = (
        ...
        if (!innerParams.toast) {
            globalState.keydownHandler = (e) =>
                keydownHandler(instance, e, dismissWith);
    ...
    const keydownHandler = (instance, e, dismissWith) => {
        ...
        if (e.key === "Enter") {
            ...
            [...arrowKeysNextButton, ...arrowKeysPreviousButton].includes(e.key)
        ) {
            handleArrows(e.key);
        } // ESC
    ...
    const handleArrows = (key) => {
        ...
        if (
            ![confirmButton, denyButton, cancelButton].includes(
